...
import { assignRestaurantOwnerByPhone, lookupRestaurantOwner } from '@/lib/api';
...
export function OwnerAssignModal({
  ...
  async function search() {
    ...
    setPhase('searching');
    try {
      const found = await lookupRestaurantOwner(phone.trim());
      setCandidate(found);
  ...
  async function confirm() {
    ...
    setErr(null);
    try {
      await assignRestaurantOwnerByPhone(restaurantId, phone.trim());
      onAssigned();
      onClose();
    } catch (e) {
      setErr((e as Error).message);
    ...
    >
      <div className="dialog-box" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="dialog-msg">
          <strong>{restaurantName}</strong> oshxonasi egasining telefon raqamini
          ...
          <div className="owner-lookup-card owner-lookup-card--miss">
            ...
            <div>
              ...
              <div className="owner-lookup-sub">
                ...
                oshxona egasi ilovaga shu raqam bilan bir marta kirishi kerak.
              </div>
            </div>
          </div>
        )}
