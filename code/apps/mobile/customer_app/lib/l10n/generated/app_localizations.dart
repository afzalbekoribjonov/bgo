...
abstract class AppLocalizations {
  ...
  /// No description provided for @restaurantClosedBanner.
  ///
  /// In uz, this message translates to:
  /// **'Bu oshxona hozircha yopiq — buyurtma qabul qilinmaydi'**
  String get restaurantClosedBanner;
  ...
  /// No description provided for @yourOrderLabel.
  ///
  /// In uz, this message translates to:
  /// **'Buyurtmangiz'**
  String get yourOrderLabel;
  ...
  /// No description provided for @promoCheck.
  ///
  /// In uz, this message translates to:
  /// **'Tekshirish'**
  String get promoCheck;

  /// No description provided for @promoNeedsCheck.
  ///
  /// In uz, this message translates to:
  /// **'Avval promokodni tekshiring'**
  String get promoNeedsCheck;
  ...
  /// No description provided for @profilePersonalSub.
  ///
  /// In uz, this message translates to:
  /// **'Ism va shaxsiy ma\'lumotlar'**
  String get profilePersonalSub;

  /// No description provided for @profileAddressesSub.
  ///
  /// In uz, this message translates to:
  /// **'Uy, ish va saqlangan manzillar'**
  String get profileAddressesSub;

  /// No description provided for @profileOrdersSub.
  ///
  /// In uz, this message translates to:
  /// **'Ovqat, taksi va dostavka tarixi'**
  ...
  /// No description provided for @profileKitchenSub.
  ///
  /// In uz, this message translates to:
  /// **'Oshxona panelini boshqarish'**
  String get profileKitchenSub;

  /// No description provided for @profilePhoneLocked.
  ///
  /// In uz, this message translates to:
  /// **'Telefon raqami hisobingizga bog\'langan — o\'zgartirib bo\'lmaydi'**
  ...
  /// No description provided for @msgProfileSub.
  ///
  /// In uz, this message translates to:
  /// **'Administratordan e\'lonlar'**
  String get msgProfileSub;
