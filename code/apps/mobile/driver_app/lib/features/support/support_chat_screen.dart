...
class _SupportChatScreenState extends ConsumerState<SupportChatScreen> {
        ...
        title: Row(
          children: [
            Container(
              ...
              height: 38,
              decoration: BoxDecoration(
                color: _supportBrand.withValues(alpha: 0.12),
                shape: BoxShape.circle,
              ),
              child: const Icon(Icons.support_agent_rounded,
                  size: 20, color: _supportBrand),
            ),
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.chat_bubble_outline_rounded,
                    size: 34, color: _supportBrand.withValues(alpha: 0.7)),
              ),
  ...
  Widget _bubble(AppLocalizations t, SupportMessage m, ColorScheme scheme) {
    ...
    final bubble = Container(
      ...
      decoration: BoxDecoration(
        color: mine ? _supportBrand : scheme.surface,
            ...
            Padding(
              ...
              child: Text(roleLabel,
                  style: TextStyle(
                      ...
                      color: (mine ? Colors.white : _supportBrand)
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Icon(icon, size: 14, color: _supportBrand),
          ),
            ...
            Container(
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [_supportBrand, _supportBrandDark],
                ...
                boxShadow: [
                  BoxShadow(
                      color: _supportBrand.withValues(alpha: 0.35),
                      blurRadius: 8,
...
/// To'liq kengliqdagi gradient tugma — Yordam bo'limida qayta ishlatiladi
/// (customer_app'dagi BrandButton'ning driver_app uchun soddalashtirilgan
/// muqobili — bu ilovada umumiy shunday komponent yo'q).
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: _supportBrand.withValues(alpha: 0.32),
              blurRadius: 12,
