...
/// Har qanday ro'yxat/ekran `error:` tarmog'ida shu ishlatiladi.
class AsyncErrorRetry extends StatelessWidget {
  final Object error;
  final VoidCallback onRetry;
  /// ListView ichida (RefreshIndicator) ishlatish uchun scroll o'rab beradi.
  ...
  Widget build(BuildContext context) {
    ...
    final color = network ? const Color(0xFFEF6C00) : scheme.error;
    ...
    // RefreshIndicator ishlashi uchun doim scroll bo'ladigan o'ram.
