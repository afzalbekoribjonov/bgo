...
/**
 * Rasm yuklash (faqat admin). ImageKit sozlangan bo'lsa — unga, aks holda
 * lokal diskka saqlanadi va gateway orqali statik ko'rsatiladi. Ikkala
 * holatda ham javob bir xil: { url } — frontend farqini sezmaydi.
 */
@Controller('market/upload')
...
export class UploadController {
  ...
  async upload(@UploadedFile() file?: UploadedImageFile) {
    ...
    return { success: true, data: { url: `${base}/api/v1/market/uploads/${name}` } };
  }
