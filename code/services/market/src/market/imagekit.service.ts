 ...
 * hamma narsa (katalog/layk/izoh/chat) ishlayveradi.
 */
@Injectable()
export class ImageKitService {
  ...
  /**
   * Client (admin_web) to'g'ridan-to'g'ri ImageKit REST API'ga yuklashi uchun
   * kerakli hamma narsa: imzolangan parametrlar + publicKey (bu maxfiy emas —
   * ImageKit dizayni bo'yicha ochiq kalit).
   */
  uploadAuthParams(): {
    token: string;
    expire: number;
